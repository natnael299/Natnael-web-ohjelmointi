...
const tyokokemus = [
  ...
  },
  {
    ...
    description: "Toteutin responsiivisia sivuja HTML-, CSS- ja JavaScript-teknologioilla ja osallistuin käyttöliittymäparannuksiin asiakasprojekteissa. Tein tiivistä yhteistyötä suunnittelijoiden kanssa, jotta käyttöliittymät olivat saavutettavia ja yhtenäisiä.",
    ...
    responsibilities: [
      "Rakensin uusia sivukomponentteja design-järjestelmän pohjalta",
  ...
  },
  {
    ...
    description: "Rakensin pieniä API-ominaisuuksia Node.js:lla ja tein tietokantamuutoksia MySQL:ään osana kehitystiimiä. Opin versionhallinnan, testien kirjoittamisen perusteita ja backend-virheiden tehokasta diagnosointia.",
  ...
  },
  {
    ...
    description: "Autoin projektitiimiä verkkosovelluksen testauksessa, bugikorjauksissa ja dokumentoinnissa sprinttien aikana. Vastasin regressiotestauksen organisoinnista ennen julkaisuja.",
  ...
  },
  {
    ...
    responsibilities: [
      "Keräsin asiakasvaatimukset ja pilkoin ne toteutettaviksi tehtaviksi",
      "Rakensin sivut ja integraatiot analytiikkaan sekä yhteyslomakkeisiin",
